...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content x-scroll-view" xid="content1" _xid="C79E6420FA60000168721FE014901907"
      style="bottom: 0px; background-size: cover; background-image: url(http://localhost:47487/x5/UI2/v_/OTO/pages/userInfo/none);">
