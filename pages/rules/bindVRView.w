...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div class="x-panel-content tb-trans" xid="content-main" id="welBind" _xid="C78FAA2F9CA000018BB5F64C1B902F90"
            ...
            <div class="section-card content-detail input-card"> 
                  ...
                  <div xid="div9" style="width:80%;display:inline-block;"> 
                    <div component="$UI/system/components/justep/labelEdit/labelEdit"
                      ...
                      <div class="x-edit" xid="div4"> 
                        <span xid="span3" style="color:#868686;" id="deviceIdInfo"></span> 
                      </div> 
                    </div> 
                  </div> 
                </div>  
              ...
              <div class="mgt-20"> 
                <div class="flex-layout mgt-20"> 
                  ...
                  <a component="$UI/system/components/justep/button/button"
                    class="btn btn-default button mgr-20" label="开始使用" id="bindButton"
                    bind-click="beginUse" style="display: none;"> 
                    <i xid="i2"/>  
                    <span xid="span2">开始使用</span> 
                  </a>
                </div> 
              </div>  
            </div> 
