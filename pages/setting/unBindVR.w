...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-top" xid="top1"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" title="设备解绑"
        ...
        <div class="x-titlebar-title"><![CDATA[设备解绑]]></div>  
    ...
    <div class="x-panel-content" xid="content1"> 
      <div xid="div1" style="text-align:center;padding-top:20px;"> 
        <div xid="div2" class="clearfix b-modify-one"> 
          <input class="form-control pull-left" id="deviceId" xid="deviceId" 
          	 type="text" readonly="readonly" bind-value="devId"/>
        </div>  
        <div xid="div3" class="clearfix b-modify-one"> 
          <input class="form-control pull-left" id="devicePwd" xid="devicePwd" 
          placeHolder="设备密码" type="password"/>
        </div> 
      </div>  
      ...
      <div xid="div6" style="text-align:center;margin-top:35px;" class="clearfix b-user-thr"> 
        <a component="$UI/system/components/justep/button/button" class="btn btn-default b-user-thrButton"
          label="确定" xid="button1" bind-click="unbindVR"> 
          <i xid="i1"/>  
