...
var __parent0=require('$model/UI2/demo/page/interactive/dialog'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='caQ7VJz';
	this._flag_='dbfdaf2d7f87c274981c723a7cc6edcb';
	this.callParent(contextUrl);
 var __Data__ = require("$UI/system/components/justep/data/data");new __Data__(this,{"autoLoad":true,"confirmDelete":true,"confirmRefresh":true,"defCols":{"age":{"define":"age","label":"年龄","name":"age","relation":"age","rules":{"integer":true},"type":"Integer"},"name":{"define":"name","label":"姓名","name":"name","relation":"name","type":"String"}},"directDelete":false,"events":{},"idColumn":"name","initData":"[]","limit":20,"xid":"dlgData"});
}}); 
return __result;});
