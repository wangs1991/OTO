  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div class="x-panel-content" xid="content1">
      <div xid="div1" style="text-align:center;padding-top:20px;"> 
        <div xid="div2" class="clearfix b-modify-one" style="margin-top:35px;text-align:center;width:80%;display:inline-block;"> 
          <input type="text" value="" xid="input1" class="form-control pull-left" placeholder="请输入手机号"/>
        </div> 
      </div>  
