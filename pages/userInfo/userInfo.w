...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;top:83px;height:244px;"
    onLoad="modelLoad"><div component="$UI/system/components/justep/data/data" autoLoad="true" xid="sexData" idColumn="id">
   ...
   <data xid="default1">[{&quot;id&quot;:&quot;0&quot;,&quot;sex&quot;:&quot;0&quot;,&quot;text&quot;:&quot;女&quot;},{&quot;id&quot;:&quot;1&quot;,&quot;sex&quot;:&quot;1&quot;,&quot;text&quot;:&quot;男&quot;}]</data></div></div>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
          ...
          <div xid="div13" class="b-user-topBox"> 
            <div xid="div4" class="clearfix b-user-one"> 
              <div xid="div8" class="fl b-user-oneA"> 
                ...
                <input name="face" id="face" style="display: none;" />	
              </div>  
              <div xid="div4" class="fl b-user-two"> 
                <div xid="div9" class="clearfix b-user-twoA"> 
                  ...
                  <input type="text" bind-value="user.name" name="name" xid="input2" class="fl"/>  
                  ...
                  <input type="text" id="sexTxt" xid="input3" class="fl b-user-twoInput"
                      bind-click="selectSex" bind-value="user.sexTxt"/>
                ...
                <div xid="div5" class="clearfix b-user-twoA b-user-twoB"> 
                  ...
                  <input type="text" bind-value="user.birthday" bind-click="selectDate" name="birthday" id="birthday" xid="input4"
                    class="fl"/> 
                </div> 
              </div> 
            </div>  
            <div xid="div17" style="margin:10px;"> 
              <div xid="div10" class="clearfix b-user-twoA b-user-twoC"> 
                ...
                <input type="text" bind-value="user.phone" name="phone" xid="input6" class="fl"/> 
              </div>  
              <div xid="div11" class="clearfix b-user-twoA b-user-twoC"> 
                ...
                <input type="text" bind-value="user.idCard" name="idCard" xid="input7" class="fl"/> 
              </div>  
              <div xid="div12" class="clearfix b-user-twoA b-user-twoC"> 
                ...
                <input type="text" bind-value="user.vocation" name="vocation" xid="input8" class="fl"/> 
              </div> 
            </div> 
          </div>  
    ...
    <div component="$UI/system/components/justep/picker/popPicker" class="x-popPicker" xid="sexSelector" onOK="getSex">
   <div class="x-popPicker-overlay" xid="div43"></div>
   <div class="x-popPicker-content" xid="div44">
    <div class="x-poppicker-header" xid="div45">
     <button class="btn btn-default x-btn-ok" xid="button7">确定</button></div> 
    <div component="$UI/system/components/justep/picker/picker" class="x-picker x-picker-2" xid="list1" data="sexData" style="width: 100%;">
     <div class="x-picker-inner" xid="div2">
      <div class="x-pciker-rule x-pciker-rule-ft" xid="div18"></div>
      <ul class="x-list-template x-pciker-list" xid="listTemplateUl1">
       <li xid="li1" bind-text="val('text')"></li></ul> 
      <div class="x-pciker-rule x-pciker-rule-bg" xid="div19"></div></div> </div> </div> </div></div> 
  </div> 
</div>
