...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" onLoad="modelLoad"
    onParamsReceive="modelParamsReceive" onActive="modelLoad" onInactive="modelUnLoad" onunLoad="modelUnLoad" style="top:156px;left:682px;height:auto;"/>  
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full"
    ...
    <div xid="div7" class="b-psy-one" bind-click="goBindVR"> 
      <div xid="div8" class="b-psy-oneA" id="unbindp" style="display: none;"> 
        <img src="$UI/OTO/assets/img/no-vr.png" alt="" xid="image1"/>  
        <span xid="span3">头盔未连接</span> 
      </div>  
      <div xid="div8" class="b-psy-oneA" id="bindp" style="display: none;"> 
        ...
        <div class="x-scroll-content" xid="div2"> 
          <div xid="div4" class="b-exam-one"> 
            <img src="$UI/OTO/assets/img/breath_1.jpg" alt="" xid="image2"
              class="b-exam-oneB"/>  
            <form name="publicOpt" id="publicOpt"> 
                  ...
                  <div xid="div12" class="b-exam-four clearfix"> 
                    <div xid="div11" class="b-exam-fourA fl"> 
                      <select component="$UI/system/components/justep/select/select"
                        class="form-control" xid="select2" name="sceneId" id="senceOptionPublic"> 
