...
var __parent0=require('$model/UI2/demo/page/core/cssPart/dialog'); 
var __result = __parent1._extend(__parent0).extend({
	...
	this.__id='';
	this.__cid='cq6Vj2y';
	this._flag_='c1345d11770b3d4fdd595f4993b722ff';
	this.callParent(contextUrl);
 require('css!$UI/demo/page/core/cssPart/dialog1').load();
}}); 
return __result;});
